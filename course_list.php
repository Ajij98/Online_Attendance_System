        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              ...
              <div class="card-body">
                <a class="btn btn-primary mb-3" href="add_course.php" role="button">Add Course</a>
                <table id="user_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="edit_course.php?course_id=<?php echo $result['course_id']; ?>" class="btn btn-info btn-sm px-3">Edit</a> || <a href="delete_data.php?course_id=<?php echo $result['course_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger btn-sm">Delete</a></td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
