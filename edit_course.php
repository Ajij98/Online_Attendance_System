<?php
 ...
 <?php
   ...
   if(isset($_GET['course_id']))
   {
     ...
     $sql    = "SELECT * FROM tb_course WHERE course_id = $course_id";

     $result = $db->select($sql);

     while($getData = $result->fetch_assoc())
     {
       $course_title = $getData['course_title'];
       $course_code  = $getData['course_code'];
     }
   }
  ?>
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
       if(checkCourseCode())
       {
         ...
         $sql = "UPDATE tb_course SET course_title='$course_title',course_code='$course_code',user_name='$user_name',entry_time='$current_datetime' WHERE course_id = $course_id";
          ...
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="course_title" id="name" value="<?php echo $course_title; ?>" required>
                </div>
                <div class="form-group">
                  <label for="name">Course Code</label>
                  <input type="text" class="form-control" id="name" name="course_code" value="<?php echo $course_code; ?>" required>
                </div>
