  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         if($image != "")
         {
           ...
           $sql = "UPDATE tb_teacher SET name='$name',email='$email',phone='$phone',address='$address',qualification='$qualification',image='$dst_db',user_name='$user_name',password='$password',added_by='$added_by',entry_time='$current_datetime' WHERE teacher_id = $teacher_id";

           $update_row = $db->update($sql);
         }

          $sql = "UPDATE tb_teacher SET name='$name',email='$email',phone='$phone',address='$address',qualification='$qualification',user_name='$user_name',password='$password',added_by='$added_by',entry_time='$current_datetime' WHERE teacher_id = $teacher_id";
        ...
        <div class="card w-75 m-auto">
          ...
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                  <img src="<?php echo $image; ?>" height="80"><br>
