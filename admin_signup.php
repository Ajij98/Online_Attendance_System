...
<?php
    ...
    if(checkUsername())
    {
      if(checkEmail())
      {
        if(matchPassword())
        {
          ...
          $sql = "INSERT INTO          tb_admin(user_name,email,phone,password,image,added_by,entry_time)values('$user_name','$email','$phone','$password','$dst_db','$added_by','$current_datetime')";
          ...
          if($insert_row)
          {
            ?>
             <script type="text/javascript">
               window.alert("Success! Registration Successful, Thank You!");
             </script>
            <?php
  ...
  function matchPassword(){
    if($_POST['password'] !== $_POST['confirm_pass'])
    {
      ?>
       <script type="text/javascript">
         window.alert("Warning! Password and Confirnmpassword should match.");
       </script>
      <?php
    }
    else
    ...
    <div class="row">
      <div class="col">
        <div class="card w-75 m-auto">
          <h5 class="card-header">SingUp Info</h5>
          <div class="card-body">
