<?php
 ...
 ?>
  ...
  <!--ASSIGNED COURSE TEACHER TABLE DATA LOAD-->
  <?php
    $db   = new Database();
    $sql  = "SELECT * FROM tb_assign_course_teacher";
    $read = $db->select($sql);
  ?>
  ...
  <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Manage Couse Teacher</li>
        </ol>
        <h2>Course Teacher List</h2>
        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              <h5 class="card-header">Assigned Course Teacher</h5>
              <div class="card-body">
                <a class="btn btn-primary mb-3" href="add_course_teacher.php" role="button">Add Course Teacher</a>
                <table id="assign_course_teacher_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $result['dateOfAssign']; ?></td>
                        <td><a href="update_assign_course_teacher.php?course_teacher_id=<?php echo $result['course_teacher_id']; ?>" style="border-radius: 3px;" title="update" class="btn btn-info btn-sm px-3">Edit</a> || <a href="delete_data.php?course_teacher_id=<?php echo $result['course_teacher_id']; ?>" style="border-radius: 3px;" title="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a></td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
...
<script>
  ...
  $(document).ready(function() {
    $('#assign_course_teacher_table').DataTable( {
        responsive: true,
        columnDefs: [
