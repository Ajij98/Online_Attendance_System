...
<?php
  ...
  $sql  = "SELECT DISTINCT a.name,b.student_id,b.section,b.trimester,b.course_title FROM
           tb_student AS a INNER JOIN tb_attendance AS b ON a.student_id=b.student_id";
  $read = $db->select($sql);
?>
                ...
                <table id="overll_attendance_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm px-3" href="create_overall_report_admin.php?section=<?php echo $result['section']; ?>&trimester=<?php echo $result['trimester']; ?>&course_title=<?php echo $result['course_title']; ?>&student_id=<?php echo $result['student_id']; ?>"><i class="fa fa-file-pdf-o fa-fw"></i> Create Report</a>
                        </td>
