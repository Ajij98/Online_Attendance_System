<?php
 ...
 <!--ATTENDANCE LIST TABLE DATA LOAD-->
  <?php
    ...
    $db   = new Database();
    $sql  = "SELECT DISTINCT section,trimester,course_title,attendance_date FROM tb_attendance WHERE teacher_name='$teacher_name'";
    $read = $db->select($sql);
    ?>
...
<head>
  ...
  <title>OAS | Attendance(Datewise)</title>
        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              ...
              <div class="card-body">
                <a class="btn btn-primary mb-3" href="take_attendance.php" role="button">Take Attendance</a>
                <table id="datewise_attendance_view_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm px-3" href="attendance_view_update.php?date=<?php echo $result['attendance_date']; ?>&section=<?php echo $result['section']; ?>&trimester=<?php echo $result['trimester']; ?>&course_title=<?php echo $result['course_title']; ?>">View</a>
                          ...
                          <a class="btn btn-success btn-sm px-3" href="create_attendance_report_teacher.php?date=<?php echo $result['attendance_date']; ?>&section=<?php echo $result['section']; ?>&trimester=<?php echo $result['trimester']; ?>&course_title=<?php echo $result['course_title']; ?>"><i class="fa fa-file-pdf-o fa-fw"></i> Create Report</a>
                        </td>
