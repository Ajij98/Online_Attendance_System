        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              ...
              <div class="card-body">
                <a class="btn btn-primary mb-3" href="add_teacher.php" role="button">Add Teacher</a>
                <table id="teacher_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="edit_teacher.php?teacher_id=<?php echo $result['teacher_id']; ?>" class="btn btn-info btn-sm px-3">Edit</a> || <a href="delete_data.php?teacher_id=<?php echo $result['teacher_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger btn-sm">Delete</a></td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
