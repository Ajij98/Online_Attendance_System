<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
       ...
       $sql = "INSERT INTO          tb_section(section,user_name,entry_time)values('$section','$user_name','$current_datetime')";
        ...
        <div class="card w-75 m-auto">
          ...
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="text" class="form-control" name="section" id="name" required>
                </div>
