 ...
 <!--SECTION DATA LOAD-->
  <?php
   ...
   <?php
     ...
     $course_data = $db->select($sql);
    ?>


    <!-- SELECT STUDENT ATTENDANCE DATA FROM ATTENDANCE TABLE -->
     <?php
       if(isset($_GET['date']))
       {
         ...
         $sql  = "SELECT a.name,b.section,b.trimester,b.course_title,b.attendance_date,b.student_id,b.attendance FROM tb_student AS a INNER JOIN tb_attendance AS b ON a.student_id=b.student_id WHERE b.attendance_date='$date' AND b.section='$section' AND b.trimester='$trimester' AND b.course_title='$course_title'";
    ...
    <?php
      if(isset($_POST['update']))
      {
        ...
        {
          $sql = "UPDATE tb_attendance set attendance='$attendance_value' WHERE attendance_date='$date'
                  and student_id='$student_Id'";

          $update_attendance = $db->update($sql);
        }
        if($update_attendance)
        {
          ?>
          <script type="text/javascript">
            window.alert("Success! Attendance data updated successfully.");
...
<head>
  ...
  <title>OAS | View/Update Attendance</title>
...
<body>
  ...
  <section id="breadcrumbs" class="breadcrumbs">
    ...
    <section id="view_update_attendance" class="m-auto">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              <h5 class="card-header">View/Update Attendance</h5>
              <div class="card-body">

                <div class="text-center text-md-right text-lg-right">
                  <a href="attendance_date_list.php" class="btn  btn-dark px-3"><i class="fa fa-arrow-left fa-fw"></i> Back</a>
                </div>
                  ...
                  <div class="form-row p-0 m-0">
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control" id="section" name="section" required>
                        ...
                        <?php while($getData = $section_data->fetch_assoc()){ ?>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control" id="trimester" name="trimester" required>
                        <option selected>Choose...</option>
                        <?php while($getData = $trimester_data->fetch_assoc()){ ?>
                  ...
                  <div class="form-row p-0 m-0">
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control" id="course_title" name="course_title" required>
                        <option selected>Choose...</option>
                        <?php while($getData = $course_data->fetch_assoc()){ ?>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="my-3 mt-4">
                        <table id="attendance_table" class="table table-bordered display nowrap" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <?php while($result = $read->fetch_assoc()){ $i = $i + 1; ?>
                              <tr>
                                ...
                                <td>
                                  <input type="radio" name="Attendance[<?php echo $result['student_id']; ?>]" value="present" <?php if($result['attendance'] == "present") {echo "checked";} ?>>P
                                  <input type="radio" name="Attendance[<?php echo $result['student_id']; ?>]" value="absent" <?php if($result['attendance'] == "absent") {echo "checked";} ?>>A
                                </td>
                              </tr>
                            <?php } ?>
                            <?php }else{ ?>
                      ...
                      <input type="submit" class="btn btn-danger px-3" name="update" value="Update">
                    </form>
