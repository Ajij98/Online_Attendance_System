<?php
 ...
 ?>
  ...
  <!-- SELECT SECTION WISE STUDENT ATTENDANCE DATA FROM ATTENDANCE TABLE -->
  <?php
    $db = new Database();
    if(isset($_GET['date']))
    {
...
<head>
  ...
  <title>OAS | View Attendance</title>
        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              <h5 class="card-header">View Attendance(Section Wise)</h5>
              <div class="card-body">

                <div class="text-center text-md-right text-lg-right">
                  <a href="attendance_date_list_admin.php" class="btn  btn-dark px-3"><i class="fa fa-arrow-left fa-fw"></i> Back</a>
                </div>
