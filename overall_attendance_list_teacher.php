<?php
 ...
 <!--OVERALL ATTENDANCE LIST TABLE DATA LOAD-->
<?php
  $teacher_name = $_SESSION['user_name'];
  $db   = new Database();
  $sql  = "SELECT DISTINCT a.name,b.student_id,b.section,b.trimester,b.course_title FROM
           tb_student AS a INNER JOIN tb_attendance AS b ON a.student_id=b.student_id WHERE teacher_name = '$teacher_name' ";
  $read = $db->select($sql);
?>
 ...
 <!--ATTENDANCE LIST TABLE DATA LOAD-->
  <?php
    $db   = new Database();
    $sql  = "SELECT DISTINCT section,trimester,course_title,attendance_date FROM tb_attendance WHERE teacher_name='Maksudur Rahman'";
    $read1 = $db->select($sql);
    ?>
...
<head>
  ...
  <title>OAS | Overall Attendance List</title>
        ...
        <div class="row">
          <div class="col">
            <div class="card m-auto">
              <h5 class="card-header">Overall Attendance List</h5>
              <div class="card-body">
                <table id="overll_attendance_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm px-3" href="create_overall_report_teacher.php?section=<?php echo $result['section']; ?>&trimester=<?php echo $result['trimester']; ?>&course_title=<?php echo $result['course_title']; ?>&student_id=<?php echo $result['student_id']; ?>"><i class="fa fa-file-pdf-o fa-fw"></i> Create Report</a>
                        </td>
...
<script>
  ...
  $(document).ready(function() {
    $('#overll_attendance_list_table').DataTable( {
        responsive: true,
        columnDefs: [
