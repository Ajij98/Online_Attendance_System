<?php
 ...
 <?php
   ...
   if(isset($_GET['section_id']))
   {
     ...
     $sql    = "SELECT * FROM tb_section WHERE section_id = $section_id";
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
     ...
     $sql = "UPDATE tb_section SET section='$section',user_name='$user_name',entry_time='$current_datetime' WHERE section_id = $section_id";
        ...
        <div class="card w-75 m-auto">
          ...
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="text" class="form-control" name="section" id="name" value="<?php echo $section; ?>" required>
                </div>
